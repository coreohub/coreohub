...
const judgeEs: Record<JudgeDictKey, string> = {
  ...
  'nav.searchLabel': 'Número de presentación o nombre de coreografía/estudio',
  'nav.searchPlaceholder': 'N.° o nombre…',
  'nav.searchEmpty': 'Ninguna presentación encontrada.',
  'nav.deliberation': 'Deliberación de Premios',
