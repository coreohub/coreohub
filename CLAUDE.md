...
Em produção: 77 arquivos em `pages/`, 39 componentes compartilhados, 61 edge functions Supabase (62 pastas menos `_shared`), 202 migrations SQL. Números corrigidos e mantidos atualizados após a auditoria de código morto de 2026-09-10 (ver Histórico recente) — a versão anterior desta linha (~71/~30/31/90+, depois 82/43/61/192) ficou defasada 2x na mesma sessão só de rodar a limpeza.
