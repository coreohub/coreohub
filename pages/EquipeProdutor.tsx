            ...
            >
              ...
              {inviteSuccess ? (
                <div className="p-8 text-center space-y-5">
                  ...
                  {/* Compartilhar via WhatsApp — padrão Slack/Notion: link copiável
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 py-2.5 bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/15 text-slate-700 dark:text-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                    >
                      Fechar
                    </button>
                  </div>
