-- Fix: validate_workshop_pass_coupon usava só a coluna legacy `scope` (1 valor),
-- rejeitando cupons multi-scope que incluem 'workshop' combinado com outros
-- setores (ex: Workshop+Plateia) — só passava com scope EXATAMENTE 'workshop'
-- ou 'all'. Alinha ao mesmo padrão de validate_workshop_coupon (20260616):
-- aceita 'workshop' = ANY(scopes) OU scope IN ('workshop','all') legacy.
