-- Fix: get_workshop_stock pegava o lote de ordem MAIS BAIXA (ASC) em vez do
-- de ordem MAIS ALTA (DESC) entre os elegíveis (is_active + dentro da janela).
-- Efeito do bug: lote 1 sem data_fim (ou ainda dentro da janela) sempre vencia,
-- lotes 2/3 publicados nunca apareciam na vitrine nem no checkout.
