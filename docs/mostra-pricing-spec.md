...
5. ✅ **RESOLVIDO 2026-09-22 — Landing/vertical de marketing.** Implementada em `pages/LandingEspetaculo.tsx`, rota `/espetaculo`. Copy passou por 2 rodadas de reescrita (ver `CLAUDE.md` → Histórico recente 2026-09-22) — ângulo emocional do dono de estúdio de dança (medo real: "plateia vazia"/pais não rematricularem, não o valor da taxa), foto do hero do produtor, seções alternando fundo claro/escuro, FAQ com AEO/GEO. Já em produção (`main`). Seção "Prova Social" (3 cards placeholder "Depoimento em breve") removida em 2026-09-22 a pedido do produtor — sem depoimento real ainda, reintroduzir quando houver.
